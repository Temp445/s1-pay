/*
  ...
  1. New Functions
    - create_bulk_assignments: Function to handle bulk shift assignments with proper error handling
    
  2. Security
    - Functions are marked as SECURITY DEFINER to run with elevated privileges
    - Access is restricted to authenticated users through RLS policies
*/
